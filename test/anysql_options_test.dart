...
void main() {
  ...
  test('setup generator creates one editable database options file', () {
    final contents = generateAnySqlFirebaseStyleOptionsFile(
      const AnySqlSetupInput(dialect: AnySqlDialect.mysql, database: ''),
    );

    expect(contents, contains('Generated by `dart run anysql`'));
    expect(contents, contains('AnySqlConfig.mysql'));
    expect(contents, contains("host: 'localhost'"));
    expect(
      contents,
      contains(
        "database: 'TODO_MYSQL_DATABASE', // TODO: replace with your value",
      ),
    );
    expect(
      contents,
      contains(
        "username: 'TODO_MYSQL_USERNAME', // TODO: replace with your value",
      ),
    );
    expect(contents, contains('ANYSQL_MYSQL_PASSWORD'));
    expect(contents, contains('connectStore'));
    expect(contents, contains('connectBackendStore'));
    expect(contents, isNot(contains('AnySqlConfig.postgres')));
    expect(contents, isNot(contains('AnySqlConfig.sqlite')));
    expect(contents, isNot(contains('AnySqlConfig.mongodb')));
  });
